    ...
    <div className="w-full pb-12 ">
      ...
      {hasCertificate ? (
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 sm:p-6 group">
            <div className="aspect-[1.4/1] bg-cyan-950/20 border border-cyan-900/50 rounded-lg flex items-center justify-center relative overflow-hidden mb-4">
              ...
              <div className="absolute inset-x-0 bottom-8 text-center">
                <p className="text-cyan-400 font-serif text-[13px] tracking-widest uppercase">Elite Academy</p>
                <p className="text-white text-[13px] mt-2">Full-Stack Development</p>
              </div>
            </div>
            
            <h3 className="text-sm font-semibold text-white mb-1">Elite Full-Stack Certification</h3>
            <p className="text-[13px] text-zinc-400 mb-4">Issued: June 2026</p>
            
            <button className="w-full flex items-center justify-center px-4 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-white text-[13px] font-medium rounded-lg transition-colors cursor-pointer">
