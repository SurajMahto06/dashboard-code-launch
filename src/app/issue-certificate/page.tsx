        ...
        <div className="flex flex-col sm:flex-row items-center justify-between mt-6 gap-4">
          <div className="flex items-center gap-4">
            <p className="text-xs text-zinc-500">
              Showing <span className="font-medium text-zinc-300">{(currentPage - 1) * itemsPerPage + 1}</span> to <span className="font-medium text-zinc-300">{Math.min(currentPage * itemsPerPage, filteredCertificates.length)}</span> of <span className="font-medium text-zinc-300">{filteredCertificates.length}</span> results
            </p>
