          ...
          <div key={mentee.id} className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 sm:p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-white">{mentee.name}</h3>
            ...
            <div className="pt-4  flex justify-between items-center">
              <div className="text-[10px] sm:text-[11px] lg:text-xs text-zinc-500 flex flex-col">
