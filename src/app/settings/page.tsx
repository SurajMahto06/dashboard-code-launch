      ...
      <div className="grid gap-8">
        ...
        <section className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden shadow-xl">
          <div className="p-6 border-b border-zinc-800 flex items-center gap-3">
            ...
            <h2 className="text-lg font-bold text-white">Platform Details</h2>
          </div>
          ...
          <div className="p-6 space-y-4">
            <label className="flex items-center justify-between cursor-pointer group">
              <div>
                ...
                <p className="text-sm text-zinc-500">New students must verify their email before accessing courses.</p>
              </div>
            ...
            <label className="flex items-center justify-between cursor-pointer group">
              <div>
                ...
                <p className="text-sm text-zinc-500">Disable login for non-admin users.</p>
              </div>
              <div className="relative inline-block w-12 mr-2 align-middle select-none transition duration-200 ease-in">
